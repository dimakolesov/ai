...
REWARDS = {
    "phrases": {
        ...
        "cost": 100,
        "description": "Открывает редкие ответы виртуальной подруги"
    },
    "personal_topics": {
    ...
    "emotions": {
        ...
        "cost": 200,
        "description": "Разные состояния виртуальной подруги (весёлая, задумчивая, заботливая)"
    },
    "surprise_letter": {
        "name": "Сюрприз от виртуальной подруги",
        "cost": 300,
        "description": "Личное письмо от виртуальной подруги"
    },
    "compatibility_check": {
        "name": "Проверка совместимости",
        "cost": 250,
        "description": "Оценка вашей связи с виртуальной подругой"
    }
}
...
def format_achievements_message(unlocked_achievements: list) -> str:
    ...
    if not unlocked_achievements:
        return "🏆 У тебя пока нет достижений. Продолжай общаться с виртуальной подругой, чтобы их получить!"
...
def calculate_compatibility(points: int, level: int, streak_days: int) -> int:
    """Вычисляет процент совместимости с виртуальной подругой."""
...
def get_compatibility_message(compatibility: int) -> str:
    ...
    if compatibility >= 90:
        return f"Твоя близость с виртуальной подругой — {compatibility}%! Вы родственные души! 💕✨"
    elif compatibility >= 80:
        return f"Твоя близость с виртуальной подругой — {compatibility}%! Вы очень близки! 💖"
    elif compatibility >= 70:
        return f"Твоя близость с виртуальной подругой — {compatibility}%! У вас отличная связь! 💕"
    elif compatibility >= 60:
        return f"Твоя близость с виртуальной подругой — {compatibility}%! Вы хорошо понимаете друг друга! 😊"
    elif compatibility >= 50:
        return f"Твоя близость с виртуальной подругой — {compatibility}%! Вы становитесь ближе! 💫"
    else:
        return f"Твоя близость с виртуальной подругой — {compatibility}%! Продолжайте общаться! 🌟"
